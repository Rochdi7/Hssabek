                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="home">
                                    <p class="mb-0">Welcome to the dashboard! Access key metrics, recent updates, and
                                        quick links to manage your activity. Use this panel to stay on top of your workflow
                                        and performance goals.</p>
                                </div>
                                <div class="tab-pane show active" id="profile">
                                    <p class="mb-0">Manage your profile details, update your contact info, and review your
                                        login activity. Keeping your account information accurate ensures a smooth and
                                        secure experience.</p>
                                </div>
                                <div class="tab-pane" id="message">
                                    <p class="mb-0">View recent messages, send new replies, and stay connected with your
                                        team. The messaging center helps you manage conversations efficiently and never miss
                                        important updates.</p>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="solid-tab2">
                                    <p class="mb-0">Manage your profile details, update your contact info, and review
                                        your login activity. Keeping your account information accurate ensures a smooth and
                                        secure experience.</p>
                                </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                            ...
                                            <p class="mb-0">View recent messages, send new replies, and stay connected
                                                with your team. The messaging center helps you manage conversations
                                                efficiently and never miss important updates.</p>
                                        </div>
                                    </div> <!-- end tab-content-->
                                </div> <!-- end col -->
                            </div>
