                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative shadow-lg">
                            <div class="card-body">
                                <div
                                    class="d-flex bg-body-tertiary p-2 rounded-2 align-items-center justify-content-between mb-2">
                                    <div>
            ...
            <div class="mb-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <div id="reportrange" class="reportrange-picker d-flex align-items-center">
                        <i class="isax isax-calendar text-gray-5 fs-14 me-1"></i><span class="reportrange-picker-field">19
                            Apr 25 - 19 Apr 25</span>
                    </div>
                </div>
