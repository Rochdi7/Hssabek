                            ...
                            <div class="d-flex align-items-center justify-content-between mb-2 pb-1">
                                ...
                                <div>
                                    <p class="data-attributes">
                                        <span
                                            data-peity='{ "fill": ["#7539FF", "rgba(67, 87, 133, .09)"], "innerRadius": 16, "radius": 32 }'>6/7</span>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2 pb-1">
                                ...
                                <div>
                                    <p class="data-attributes">
                                        <span
                                            data-peity='{ "fill": ["#3F8BFE", "rgba(67, 87, 133, .09)"], "innerRadius": 16, "radius": 32 }'>4/7</span>
                                    </p>
                                </div>
                            </div>
                            <p class="fs-13 text-center border rounded-1 p-2 bg-light mb-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2 pb-1">
                                ...
                                <div>
                                    <p class="data-attributes">
                                        <span
                                            data-peity='{ "fill": ["#27AE60", "rgba(67, 87, 133, .09)"], "innerRadius": 16, "radius": 32 }'>2/7</span>
                                    </p>
                                </div>
                            </div>
                            <p class="fs-13 text-center border rounded-1 p-2 bg-light mb-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2 pb-1">
                                ...
                                <div>
                                    <p class="data-attributes">
                                        <span
                                            data-peity='{ "fill": ["#EF1E1E", "rgba(67, 87, 133, .09)"], "innerRadius": 16, "radius": 32 }'>1/7</span>
                                    </p>
                                </div>
                            </div>
                            <p class="fs-13 text-center border rounded-1 p-2 bg-light mb-0">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                            data-bs-toggle="modal" data-bs-target="#view_invoice_modal"><i
