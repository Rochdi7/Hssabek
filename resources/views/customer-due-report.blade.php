            ...
            <div class="border-bottom mb-3">
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div
                            class="card shadow-lg position-relative border-0 border-bottom border-3 border-primary custom-border">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div
                            class="card shadow-lg position-relative border-0 border-bottom border-3 border-success custom-border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="me-2">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div
                            class="card shadow-lg position-relative border-0 border-bottom border-3 border-warning custom-border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="me-2">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div
                            class="card shadow-lg position-relative border-0 border-bottom border-3 border-danger custom-border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="me-2">
                ...
                <table class="table table-nowrap datatable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>$10,000</td>
                            <td>$5,000</td>
                            <td><span class="badge badge-soft-success d-inline-flex align-items-center">Paid <i
                        ...
                        <tr>
                            ...
                            <td>$15,000</td>
                            <td>$10,750</td>
                            <td><span class="badge badge-soft-warning d-inline-flex align-items-center">Pending <i
                                        class="isax isax-timer ms-1"></i></span></td>
                            <td>$100</td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>$20,000</td>
                            <td>$20,000</td>
                            <td><span class="badge badge-soft-danger d-inline-flex align-items-center">Cancelled <i
