                            ...
                            <div class="card invoice-report  flex-fill">
                                ...
                                <div class="card-body d-flex flex-wrap align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="badge badge-sm badge-soft-success me-3">+5.62% <i
                                    ...
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        <span
                                            class="avatar avatar-md br-5 d-flex align-items-center justify-content-center  bg-transparent-primary border border-primary">
                                            <span class="text-primary d-flex"><i
                                                    class=" isax isax-dollar-circle fs-16"></i></span>
                                        </span>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 d-flex">
                            <div class="card invoice-report  flex-fill">
                                ...
                                <div class="card-body d-flex flex-wrap align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        <span
                                            class="avatar avatar-md br-5 d-flex align-items-center justify-content-center  bg-transparent-success border border-success">
                                            <span class="text-success d-flex"><i
                                                    class=" isax isax-tick-circle4 fs-16"></i></span>
                                        </span>
                                    </div>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 d-flex">
                            <div class="card invoice-report  flex-fill">
                                ...
                                <div class="card-body d-flex flex-wrap align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        <span
                                            class="avatar avatar-md br-5 d-flex align-items-center justify-content-center  border border-warning">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 d-flex">
                            <div class="card invoice-report  flex-fill">
                                ...
                                <div class="card-body d-flex flex-wrap align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        <span
                                            class="avatar avatar-md br-5 d-flex align-items-center justify-content-center bg-transparent-danger border border-danger">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="fs-14 fw-medium mb-0"><a href="{{ url('customer-details') }}">Emily
                                                Clark</a></h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="#"
                                        class="badge badge-soft-success badge-md d-inline-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="#"
                                        class="badge badge-soft-danger badge-md d-inline-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="#"
                                        class="badge badge-soft-info badge-md d-inline-flex align-items-center">
