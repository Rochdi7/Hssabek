                        ...
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <span
                                            class="badge badge-soft-primary border border-primary rounded p-2 d-inline-flex align-items-center justify-content-center">
                        ...
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <span
                                            class="badge badge-soft-success border border-success rounded p-2 d-inline-flex align-items-center justify-content-center">
                        ...
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <span
                                            class="badge badge-soft-warning border border-warning rounded p-2 d-inline-flex align-items-center justify-content-center">
                        ...
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <span
                                            class="badge badge-soft-danger border border-danger rounded p-2 d-inline-flex align-items-center justify-content-center">
