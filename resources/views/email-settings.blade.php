                            ...
                            <div>
                                <div class="pb-3 d-flex align-items-center justify-content-between border-bottom mb-3">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#sendgrid"><i class="isax isax-send-25 me-1"></i>Send Test Email</a>
                                </div>
                                <div class="mb-0">
                                    <div class="row">
                                        <div class="col-md-6 d-flex">
                                            <div class="card flex-fill">
                                                <div class="card-body">
                                                    ...
                                                    <p class="fs-13">Used to send emails safely and easily via PHP code
                                                        from a web server.</p>
                                                </div>
                                        ...
                                        <div class="col-md-6 d-flex">
                                            <div class="card flex-fill">
                                                <div class="card-body">
                                                    ...
                                                    <p class="fs-13">SMTP is used to send, relay or forward messages from a
                                                        mail client.</p>
                                                </div>
                                                <div class="card-footer bg-light">
                                                    <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="card flex-fill">
                                                <div class="card-body">
                                                    <div
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <span class="avatar avatar-lg bg-light me-2 p-2 flex-shrink-0">
                                                                <img src="{{ URL::asset('build/img/settings/sendgrid.svg') }}"
                                                                    class="img-fluid" alt="img">
                                                            </span>
                                                    ...
                                                    <p class="fs-13">Cloud-based email marketing tool that assists
