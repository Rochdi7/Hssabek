                ...
                <table class="table table-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Great insights! This article really helped me understand the topic better. Looking forward
                                to more informative content from you!</td>
                            <td>22 Feb 2025</td>
                        ...
                        <tr>
                            ...
                            <td>Excellent write-up! The examples made it easier to grasp the concept. Keep sharing such
                                valuable knowledge with your readers!</td>
                            <td>07 Feb 2025</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>I never thought about it this way. Your perspective is truly eye-opening. Thanks for sharing
                                such a detailed explanation!</td>
                            <td>30 Jan 2025</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>Very informative and well-structured content. I appreciate the effort you put into breaking
                                down this complex topic. Well done!</td>
                            <td>17 Jan 2025</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>This was exactly what I needed to read today. Your points are well-articulated and backed by
                                solid reasoning. Thank you!</td>
                            <td>04 Jan 2025</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>Impressive analysis! You covered all the key aspects thoroughly. The writing style is
                                engaging and keeps readers hooked until the end.</td>
                            <td>02 Dec 2024</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>Thanks for sharing! The step-by-step approach really helps in understanding. Can you provide
                                more examples on this subject?</td>
                            <td>15 Nov 2024</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>Insightful read! I particularly liked the way you explained complex ideas in simple terms.
                                Looking forward to your next post!</td>
                            <td>30 Nov 2024</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>Brilliant content! This was very helpful for beginners like me. Please share more tips on
                                practical applications of this concept.</td>
                            <td>12 Oct 2024</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>Your writing always provides clarity. I appreciate how you simplify technical topics without
                                losing depth. Keep up the great work!</td>
                            <td>05 Oct 2024</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-33.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                            ...
                            <td>Great points! I learned something new today. Would love to hear your thoughts on how this
                                applies in real-world scenarios.</td>
                            <td>09 Sep 2024</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-34.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                            ...
                            <td>This post stands out because of its well-researched insights. I appreciate the detailed
                                breakdown. Looking forward to more content like this!</td>
                            <td>02 Sep 2024</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-35.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                            ...
                            <td>Fantastic article! The way you structured the information made it very digestible. Keep
                                sharing such valuable knowledge with us!</td>
                            <td>02 Sep 2024</td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
                                ...
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        ...
                                        <span class="avatar avatar-sm rounded-circle me-2"><img
                                                ...
                                                class="flex-shrink-0 rounded-circle" alt="img"></span>Michael Johnson
                                    </label>
                                </li>
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        ...
                                        <span class="avatar avatar-sm rounded-circle me-2"><img
                                                ...
                                                class="flex-shrink-0 rounded-circle" alt="img"></span>Olivia Harris
                                    </label>
                                </li>
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        ...
                                        <span class="avatar avatar-sm rounded-circle me-2"><img
                                                ...
                                                class="flex-shrink-0 rounded-circle" alt="img"></span>David Anderson
                                    </label>
                                </li>
                            </ul>
                            <div class="row g-2">
