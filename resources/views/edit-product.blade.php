                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="Adidas Ultraboost 22 Running Shoe">
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3 pb-3 border-bottom">
                                                ...
                                                <div
                                                    ...
                                                    <p class="mb-0 text-gray-9 fw-semibold">Drop Your Files or <a
                                                            href="#" class="text-primary text-decoration-underline">
                                                            Browse</a></p>
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="avatar avatar-xl border gallery-img p-1 ">
                                                        <img src="{{ URL::asset('build/img/products/product-10.jpg') }}"
                                                            alt="User Img">
                                                        <a href="javascript:void(0);"
                                                            class="rounded-trash gallery-trash d-flex align-items-center justify-content-center"><i
                                                                class="isax isax-trash"></i></a>
                                                    </div>
                                                    <div class="avatar avatar-xl border gallery-img p-1 ">
