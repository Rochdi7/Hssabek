                                ...
                                <div class="card-body">
                                    <div class=" d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                                            <span
                                                class="avatar avatar-md br-5  bg-transparent-primary border border-primary">
                                                <span class="text-primary"><i
                                                        class=" isax isax-dollar-circle fs-16 custom-icons"></i></span>
                                            </span>
                                        </div>
                                    </div>
                                    <div>
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="badge badge-sm badge-soft-success me-3">+11.4%<i
                                                                class="isax isax-arrow-up-15"></i></span>
                                                    </div>
                                ...
                                <div class="card-body">
                                    <div class=" d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center flex-column overflow-hidden">
                                            <div>
                                                <div>
                                                    <span class="fs-14 fw-normal text-truncate mb-1">UPI & Digital
                                                        Wallets</span>
                                                    <div>
                                                        <h5 class="fs-16 fw-semibold me-2 mb-1">$500,000</h5>
                                                        <span class="badge badge-sm badge-soft-success me-3">+8.12%<i
                                                                class="isax isax-arrow-up-15"></i></span>
                                                    </div>
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="badge badge-sm badge-soft-success me-3">+7.45<i
                                                                class="isax isax-arrow-up-15"></i></span>
                                                    </div>
