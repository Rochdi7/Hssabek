                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                    <div class="me-2">
                        <div class="d-flex align-items-center">
                            <a href="{{ url('packages') }}" class="btn btn-icon btn-sm border rounded me-1"><i
                                    class="isax isax-menu-1"></i></a>
                            <a href="{{ url('packages-grid') }}"
                                class="btn btn-icon border rounded btn-sm active bg-primary text-white"><i
                                    class="isax isax-grid-2"></i></a>
                        </div>
                    </div>
                    ...
                    <div>
                        <a href="javascript:void(0);" class="btn btn-primary d-flex align-items-center"
                            data-bs-toggle="modal" data-bs-target="#add_plans"><i class="isax isax-add-circle5 me-1"></i>New
                            Plan</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card border rounded mb-3">
                            <div class="card-body">
                                <div class="pricing-content mb-3">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-white border w-100 mb-3"><i
                                            class="isax isax-shopping-cart me-1"></i> Buy Plan</a>
                                    <div class="price-hdr">
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <a href="javascript:void(0);"
                                        class="btn btn-sm btn-light d-inline-flex align-items-center justify-content-center p-1 me-2"
                                        data-bs-toggle="modal" data-bs-target="#edit_plans"><i
                                            class="isax isax-edit"></i></a>
                                    <a href="javascript:void(0);"
                                        class="btn btn-sm btn-light d-inline-flex align-items-center justify-content-center p-1"
