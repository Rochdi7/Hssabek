                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    <a href="#"
                                        class="text-info text-truncate mb-2 text-wrap">https://themeforest.net/search/kanakku</a>
                                    <p class="text-truncate line-clamb-2 mb-2">Kanakku - Html, Vue 3, Angular 17+, React &
