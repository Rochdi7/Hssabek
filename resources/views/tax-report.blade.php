                    ...
                    <div class="card position-relative">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div>
                                    <span
                                        class="badge badge-soft-primary border border-primary rounded-2 p-2 d-inline-flex align-items-center justify-content-center">
                                        <i class="isax isax-dollar-circle fs-16"></i>
                                    </span>
                                </div>
                                <p class="fs-13 mb-0">
                                    <span class="badge badge-soft-success">+5.62%<i
                                            class="isax isax-arrow-up5 ms-1"></i></span>
                                </p>
                            </div>
                    ...
                    <div class="card position-relative">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div>
                                    <span
                                        class="badge badge-soft-success border border-success rounded-2 p-2 d-inline-flex align-items-center justify-content-center">
                    ...
                    <div class="card position-relative">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div>
                                    <span
                                        class="badge badge-soft-warning border border-warning rounded-2 p-2 d-inline-flex align-items-center justify-content-center">
                    ...
                    <div class="card position-relative">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div>
                                    <span
                                        class="badge badge-soft-danger border border-danger rounded-2 p-2 d-inline-flex align-items-center justify-content-center">
            ...
            <div class="mb-3">
                ...
                <div class="align-items-center gap-2 flex-wrap filter-info mt-3">
                    ...
                    <span class="tag bg-light border rounded-1 fs-12 text-dark badge"><span
                        ...
                        Selected<span class="ms-1 tag-close"><i class="fa-solid fa-x fs-10"></i></span></span>
                    <a href="javascript:void(0);" class="link-danger fw-medium text-decoration-underline ms-md-1">Clear
                        All</a>
                </div>
                <!-- /Filter Info -->
            </div>
