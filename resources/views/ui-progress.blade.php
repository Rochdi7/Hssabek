            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Use the <code>.progress</code> as a wrapper to indicate the max value of the progress bar.
                            </p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">We only set a <code>height</code> value on the <code>.progress</code>, so
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>You can include multiple progress components inside a container with
                                <code>.progress-stacked</code> to create a single stacked progress bar.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Add <code>.bg-primary-gradient</code> to any <code>.progress-bar</code> to apply a CSS
