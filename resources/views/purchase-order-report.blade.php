                            ...
                            <ul class="mb-3">
                                ...
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        ...
                                        <span class="avatar avatar-sm rounded-circle me-2"><img
                                                src="{{ URL::asset('build/img/reports/avatar-01.jpg') }}"
                                ...
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class="avatar avatar-sm rounded-circle me-2"><img
                                                src="{{ URL::asset('build/img/reports/avatar-02.jpg') }}"
                                ...
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class="avatar avatar-sm rounded-circle me-2"><img
                                                src="{{ URL::asset('build/img/reports/avatar-03.jpg') }}"
                                ...
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class="avatar avatar-sm rounded-circle me-2"><img
                                                src="{{ URL::asset('build/img/reports/avatar-04.jpg') }}"
