            ...
            <div class="col-md-10 mx-auto">
                ...
                <div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="mb-2">
                                <h6 class="fs-16 mb-1">codesommet</h6>
                                    ...
                                    <div class="p-3 border-end flex-fill">
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 text-dark">299 Star Trek Drive, Panama City, Florida, 32405,
                                                    USA.</p>
                    ...
                    <div class="py-3 border-top-0 border-bottom mb-3 d-flex align-items-center justify-content-between">
                        <p class="text-dark">Total amount ( in words): <br> One Thousand Eight Hundred Fifteen Dollars
                            Only.</p>
                    ...
                    <div class="border-bottom mb-3">
                        <p class="bg-primary-subtle p-2 text-dark fs-13 mb-3">NOTES: All accounts are to be paid within 7
                            days from receipt of invoice. To be paid by cheque or credit card or direct payment online. If
                            account is not paid within 7 days the credits details supplied as confirmation of work
                            undertaken will be charged the agreed quoted fee noted above.</p>
                    </div>
