        ...
        <div class="content content-two">
            ...
            <div class="mb-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap table-header">
                    ...
                    <div class="mb-2">
                        <a href="{{ url('add-invoice') }}" class="btn btn-md btn-primary d-flex align-items-center"><i
                            ...
                            <div>
                                <p class="d-flex align-items-center text-truncate"><span
                                        class="text-success fs-12 d-flex align-items-center me-1"><i
                                            class="ti ti-arrow-wave-right-up me-1"></i>+32.40%</span>from last month</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div>
                                <p class="d-flex align-items-center text-truncate"><span
                                        class="text-danger fs-12 d-flex align-items-center me-1"><i
                                            class="ti ti-arrow-wave-right-up me-1"></i>-4.40%</span>from last month</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div>
                                <p class="d-flex align-items-center text-truncate"><span
                                        class="text-danger fs-12 d-flex align-items-center me-1"><i
                                            class="ti ti-arrow-wave-right-up me-1"></i>-15.40%</span>from last month</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                            <h5 class="d-flex align-items-center">Invoices<span
                                    class="badge bg-light ms-2 text-dark fs-12">2000 Invoices</span></h5>
                            <div class="d-flex align-items-center flex-wrap row-gap-3 table-header">

                                <div class="input-icon position-relative me-2">
                                    <input type="text" class="form-control datetimepicker py-1 h-auto"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Anthony Lewis</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Brian Villalobos</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Harvey Smith</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Stephan Peralt</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Doglas Martini</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Linda Ray</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Elliot Murray</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Rebecca Smtih</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Connie Waters</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium fs-14"><a
                                                                href="{{ url('invoice-details') }}">Lori Broaddus</a>
                                                        </h6>
