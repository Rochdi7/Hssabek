                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="{{ url('customer-security-settings') }}"
                                                            class="fs-14 fw-medium d-flex align-items-center active"><i
                        ...
                        <div class="col-xl-9 col-lg-8">
                            <div class="mb-3">
                                ...
                                <div
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center mb-2">
                                            <span
                                                class="p-1 bg-dark rounded text-white d-inline-flex align-items-center justify-content-center me-2">
                                ...
                                <div
                                    ...
                                    <a href="javascript:void(0);" data-bs-toggle="modal"
                                        data-bs-target="#view_device"><span
                                            class="badge badge-soft-light text-dark d-inline-flex align-items-center"><i
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p class="fs-14">This will shutdown your account. Your account will be reactive
