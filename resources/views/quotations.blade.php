                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap flex-lg-nowrap flex-md-nowrap">
                        ...
                        <div id="reportrange" class="reportrange-picker d-flex align-items-center">
                            <i class="isax isax-calendar text-gray-5 fs-14 me-1"></i><span
                                class="reportrange-picker-field">21 Apr 25 - 21 Apr 25</span>
                        </div>
                ...
                <table class="table table-nowrap datatable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>22 Feb 2025</td>
                            <td>
                                <span class="badge badge-soft-success d-inline-flex align-items-center">Accepted <i
                            ...
                            <td class="action-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                                                class="isax isax-document-text-1 me-2"></i>Convert to Invoice</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                                                class="isax isax-arrow-right-2 me-2"></i>Mark as Sent</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                        ...
                        <tr>
                            ...
                            <td>07 Feb 2025</td>
                            <td>
                                <span class="badge badge-soft-danger d-inline-flex align-items-center">Declined<i
                        ...
                        <tr>
                            ...
                            <td>30 Jan 2025</td>
                            <td>
                                <span class="badge badge-soft-info d-inline-flex align-items-center">Sent<i
                                        class="isax isax-arrow-right-2 ms-1"></i></span>
                            </td>
                            <td class="action-item">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <i class="isax isax-more"></i>
