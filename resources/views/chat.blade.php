                                ...
                                <div class="d-flex align-items-center justify-content-between border border-end-0 p-3">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar me-2 flex-shrink-0"><img
                                                src="{{ URL::asset('build/img/users/user-01.jpg') }}" alt="user"></span>
                                        <div>
                                            <h6 class="fs-14 mb-1">James Hong </h6>
                                            <p class="mb-0">Admin</p>
                                        </div>
                                    </div>
                                    <a href="#" class="btn p-2 btn-primary" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-title="New Chat"><i class="ti ti-plus"></i></a>
                                </div>
                                <div>
                                    ...
                                    <div class="chat-users p-4" data-simplebar>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 flex-shrink-0"><img
                            ...
                            <div class="card border mb-0">
                                ...
                                <div
                                    ...
                                    <div class="gap-2 d-flex align-items-center flex-wrap">
                                        <a href="{{ url('voice-call') }}" class="btn btn-icon btn-light"
                                            data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh"
                                            data-bs-original-title="Voice Call"><i class="ti ti-phone"></i></a>
                                        <a href="{{ url('video-call') }}" class="btn btn-icon btn-light"
                                            data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Refresh"
                                ...
                                <div class="card-body p-0">
                                    <div class="message-body p-4" data-simplebar>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="message-box receive-message p-3">
                                                            <p class="mb-0 fs-16">Hey mark! Did you check out the new logo
                                                                design?</p>
                                                        </div>
                                                        <div class="ms-2">
                                                            ...
                                                            <ul class="dropdown-menu p-2">
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="ti ti-heart me-1"></i>Reply</a></li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="ti ti-pinned me-1"></i>Forward</a></li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                ...
                                                                <li><a class="dropdown-item" href="#"><i
                                                                        ...
                                                                        Favourite</a></li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="ti ti-trash me-1"></i>Delete</a></li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="ti ti-check me-1"></i>Mark as Unread</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="ti ti-box-align-right me-1"></i>Archeive
                                                                        Chat</a></li>
                                                                <li><a class="dropdown-item" href="#"><i
                                                                            class="ti ti-pinned me-1"></i>Pin Chat</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-start justify-content-end">
                                                <div>
                                                    <div class="d-flex align-items-center justify-content-end mb-1">
                                                        <p class="mb-0 d-inline-flex align-items-center"><i
                                                                class="ti ti-checks text-success me-1"></i>02:39 PM<i
                                                                class="ti ti-point-filled mx-2"></i></p>
                                        ...
                                        <div class="text-center"><span
                                                class="badge bg-light rounded-pill px-3 text-dark fs-14">Today</span></div>
                                        <div class="chat-list ms-auto mb-3">
                                            <div class="d-flex align-items-start justify-content-end">
                                                <div>
                                                    <div class="d-flex align-items-center justify-content-end mb-1">
                                                        <p class="mb-0 d-inline-flex align-items-center"><i
                                                                class="ti ti-checks text-success me-1"></i>10:00 AM<i
                                                                class="ti ti-point-filled mx-2"></i></p>
                                                        <h6 class="fs-14 fw-semibold mb-0">You</h6>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="message-box sent-message p-3">
                                                            <p class="mb-0 fs-16">Looks clean! I like the font. Maybe try a
                                                                slightly darker blue?</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <span class="avatar ms-2 online flex-shrink-0"><img
                                        ...
                                        <div class="chat-list mb-3">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="message-box receive-message p-3">
                                                            <p class="mb-0 fs-16">Perfect! That layout will work great on
                                                                the landing page. 👍</p>
                                                        </div>
                                                        <div class="ms-2">
                                                            <a href="javascript:void(0);" data-bs-toggle="dropdown"><i
