                                        ...
                                        <div class="sidebar-inner">
                                            <div class="sidebar-menu p-0">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="{{ url('customer-notification-settings') }}"
                                                            class="fs-14 fw-medium d-flex align-items-center"><i
                            ...
                            <div class="mb-3">
                                ...
                                <form action="{{ url('customer-plans-settings') }}">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div>
                                                            <button type="button" class="btn btn-primary btn-md"
                                                                data-bs-toggle="modal" data-bs-target="#upgrade"> <i
                                                                    class="ti ti-crown"></i> Upgrade</button>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex align-items-center mb-3">
                                            <span class="bg-dark avatar avatar-sm me-2 flex-shrink-0"><i
                                                    class="isax isax-card fs-14"></i></span>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center mb-3">
                                                            <a href="javascript:void(0);">
                                                                <img src="{{ URL::asset('build/img/settings/payment-icon-01.svg') }}"
                                                                    class="img-fluid me-2" alt="clock">
                                                            </a>
                                                            <div>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <a href="javascript:void(0);"
                                                                class="badge bg-success">Default</a>
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:void(0);"
                                                                    class="avatar bg-light text-dark avatar-md border rounded-circle me-2"><i
                                                                        class="isax isax-edit text-gray"></i></a>
                                                                <a href="javascript:void(0);"
                                                                    class="avatar bg-light text-dark avatar-md border rounded-circle"
                                                                    data-bs-toggle="modal" data-bs-target="#delete_card"><i
                                                                        class="isax isax-trash text-gray"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card shadow-none">
                                                    <div class="card-body">
                                                        <div class="d-flex align-items-center mb-3">
                                                            <a href="javascript:void(0);">
                                                                <img src="{{ URL::asset('build/img/settings/payment-icon-02.svg') }}"
                                                                    class="img-fluid me-2" alt="clock">
                                                            </a>
                                                            <div>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <a href="javascript:void(0);"
                                                                class="text-primary text-decoration-underline">Set as
                                                                Default</a>
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:void(0);"
                                                                    class="avatar bg-light text-dark avatar-md border rounded-circle me-2"><i
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                                        <div class="dropdown me-1">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="#">Download as
                                                                        PDF</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item" href="#">Download as
                                                ...
                                                <table class="table table-nowrap datatable">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge badge-soft-success d-inline-flex align-items-center">Completed
