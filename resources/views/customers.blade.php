                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('add-invoice') }}"
                                        class="btn btn-sm btn-outline-white d-inline-flex align-items-center me-1">
                        ...
                        <div class="dropdown-menu shadow-lg w-100 dropdown-info">
                            ...
                            <ul class="mb-3">
                                ...
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class=" me-2"><img src="{{ URL::asset('build/img/icons/flag-1.svg') }}"
                                                class="flex-shrink-0" alt="img"></span>United states
                                    </label>
                                </li>
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class=" me-2"><img src="{{ URL::asset('build/img/icons/flag-2.svg') }}"
                                                class="flex-shrink-0" alt="img"></span>Canada
                                    </label>
                                </li>
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class=" me-2"><img src="{{ URL::asset('build/img/icons/flag-3.svg') }}"
                                                class="flex-shrink-0" alt="img"></span>UK
                                    </label>
                                </li>
                                <li>
                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                        <span class=" me-2"><img src="{{ URL::asset('build/img/icons/flag-4.svg') }}"
                                                class="flex-shrink-0" alt="img"></span>Germany
                                    </label>
                                </li>
                            </ul>
                            <div class="row g-2">
