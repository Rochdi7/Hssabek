                            ...
                            <div class="list-group list-group-flush mails-list">
                                ...
                                <div class="list-group-item p-3">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            ...
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                                        <h6 class="fs-16 mb-1"><a href="{{ url('email-reply') }}">Justin
                                                                Lapoint</a></h6>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="d-inline-flex align-items-center"><i
                                                                class="ti ti-point-filled text-success"></i>3:13 PM</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="d-flex align-items-center btn btn-sm bg-soft-dark me-2"><i
                                                    class="ti ti-folder-open me-2"></i>3</span>
                                            <span class="d-flex align-items-center btn btn-sm bg-soft-dark"><i
                                                    class="ti ti-photo me-2"></i>+24</span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <span><i class="ti ti-star-filled text-warning"></i></span>
                                            <span
                                                class="badge badge-soft-info mx-2 d-inline-flex align-items-center p-1"><i
                                ...
                                <div class="list-group-item p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            ...
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                                        <h6 class="fs-16 mb-1"><a href="{{ url('email-reply') }}">Rufana
                                                                Joe</a></h6>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="d-inline-flex align-items-center"><i
                                                                class="ti ti-point-filled text-danger"></i>3:13 PM</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <a href="javascript:void(0);"><img
                                                src="{{ URL::asset('build/img/icons/google-meet.svg') }}"
                                                alt="Img"></a>
                                        <div class="d-flex align-items-center">
                                            <span><i class="ti ti-star-filled text-warning"></i></span>
                                            <span
                                                class="badge badge-soft-primary  d-inline-flex align-items-center p-1 mx-2"><i
                                ...
                                <div class="list-group-item p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            ...
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                                        <h6 class="fs-16 mb-1"><a href="{{ url('email-reply') }}">Cameron
                                                                Drake</a></h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="d-flex align-items-center btn btn-sm bg-soft-dark fs-14"><i
                                                    class="ti ti-video me-2"></i>1</span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <span><i class="ti ti-star-filled text-warning"></i></span>
                                            <span
                                                class="badge badge-soft-danger d-inline-flex align-items-center p-1  mx-2"><i
                                ...
                                <div class="list-group-item p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            ...
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                                        <h6 class="fs-16 mb-1"><a href="{{ url('email-reply') }}">Sean
                                                                Hill</a></h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-soft-success d-inline-flex align-items-center p-1"><i
                                ...
                                <div class="list-group-item p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            ...
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                                        <h6 class="fs-16 mb-1"><a href="{{ url('email-reply') }}">Kevin
                                                                Alley</a></h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span
                                                class="badge badge-soft-danger me-2 d-inline-flex align-items-center p-1"><i
                                                    class="ti ti-square me-1"></i>External</span>
                                            <a href="javascript:void(0);" class="badge bg-dark rounded-pill p-1">+1</a>
                                        </div>
                                    </div>
                                ...
                                <div class="list-group-item p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            ...
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                                        <h6 class="fs-16 mb-1"><a href="{{ url('email-reply') }}">Linda
                                                                Zimmer</a></h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span
                                                class="badge badge-soft-warning me-2 d-inline-flex align-items-center p-1"><i
                                ...
                                <div class="list-group-item p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            ...
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                                        <h6 class="fs-16 mb-1"><a href="{{ url('email-reply') }}">Emly
                                                                Reachel</a></h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span class="badge badge-soft-info d-inline-flex align-items-center p-1"><i
                                                    class="ti ti-square me-1"></i>Projects</span>
                                        </div>
                                    </div>
                                </div>
