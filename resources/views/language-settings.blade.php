                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="javascript:void(0);"
                                        class="btn btn-primary d-inline-flex align-items-center"><i
                                            class="isax isax-add-circle5 me-1"></i>Add New Language</a>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
                                ...
                                <a href="javascript:void(0);"
                                    class="btn btn-outline-white d-inline-flex align-items-center"><i
                                        class="isax isax-import me-1"></i>Import Sample</a>
                            </div>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ url('language-setting2') }}"
                                                        class=" me-2 flex-shrink-0"><img
                                                            src="{{ URL::asset('build/img/flags/us.svg') }}" alt="img"
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <a href="javascript:void(0);"
                                                        class="btn btn-outline-white d-inline-flex rounded-circle p-1 align-items-center justify-content-center btn-sm"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ url('language-setting2') }}" class="flex-shrink-0 me-2"><img
                                                            src="{{ URL::asset('build/img/flags/de.svg') }}" alt="img"
                                                            class="avatar avatar-xs rounded-circle"></a>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ url('language-setting2') }}"
                                                        class="flex-shrink-0 me-2"><img
                                                            src="{{ URL::asset('build/img/flags/ae.svg') }}"
                                                            alt="img" class="avatar avatar-xs rounded-circle"></a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ url('language-setting2') }}"
                                                        class="flex-shrink-0 me-2"><img
                                                            src="{{ URL::asset('build/img/flags/fr.svg') }}"
                                                            alt="img" class="avatar avatar-xs rounded-circle"></a>
