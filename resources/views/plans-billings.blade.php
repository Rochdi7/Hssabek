                                                        ...
                                                        <div>
                                                            <button type="button"
                                                                ...
                                                                data-bs-toggle="modal" data-bs-target="#upgrade"> <i
                                                                    class="isax isax-crown me-1"></i>Upgrade</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card shadow-none">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <a href="javascript:void(0);"
                                                                class="badge badge-success bg-success">Default</a>
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:void(0);"
                                                                    class="avatar text-dark avatar-md border rounded-circle me-2 bg-light"><i
                                                                        class="isax isax-edit text-gray"></i></a>
                                                                <a href="javascript:void(0);"
                                                                    class="avatar text-dark avatar-md border rounded-circle bg-light"
