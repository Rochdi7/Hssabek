            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Using the card component, you can extend the default collapse behavior to
                                create an accordion. To properly achieve the accordion style, be sure to use
                                <code>.accordion</code> as a wrapper.</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">
                                ...
                                accordion. To properly achieve the accordion style, be sure to use <code>.accordion</code>
                                as a wrapper.
                            </p>
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Omit the <code>data-bs-parent</code> attribute on each
                                <code>.accordion-collapse</code> to make accordion items stay open when another item is
                                opened.</p>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-solid-primary</code> to create a solid primary
                                accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-solid-secondary</code> to create a solid
                                secondary accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-solid-warning</code> to create a solid warning
                                accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-solid-info</code> to create a solid info
                                accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-solid-success</code> to create a solid success
                                accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-solid-danger</code> to create a solid danger
                                accordion.</p>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-border-primary</code> to create a primary border
                                accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-border-secondary</code> to create a secondary
                                border accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-border-success</code> to create a success border
                                accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-border-info</code> to create a info border
                                accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-border-warning</code> to create a warning border
                                accordion.</p>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Use the <code>.accordion-border-danger</code> to create a danger border
                                accordion.</p>
