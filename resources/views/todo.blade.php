        ...
        <div class="content content-two">
            <div class="d-flex align-items-center todo-header gap-3 justify-content-between mb-3">
                ...
                <div class="d-flex align-items-center">
                    <ul class="table-top-head flex-shrink-0 list-unstyled mb-0">
                        <li>
                            <a href="{{ url('todo') }}" class="active btn btn-icon btn-sm"><i
            ...
            <div class="card shadow-none mb-0">
                <div class="card-body">
                    ...
                    <div class="row gy-3 mb-3">
                        ...
                        <div class="col-sm-8">
                            <div class="d-flex align-items-center justify-content-end">
                                <p class="mb-0 me-3 pe-3 border-end fs-14">Total Task : <span class="text-dark"> 55 </span>
                                </p>
                    ...
                    <div class="mb-3">
                        <button class="btn bg-primary-subtle border-dashed border-primary w-100 text-start"
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center justify-content-lg-end flex-wrap row-gap-3 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="dropdown">
                                            <a href="javascript:void(0);"
                                                class="dropdown-toggle btn btn-outline-white d-inline-flex align-items-center border-0 bg-transparent p-0 text-dark pe-4"
                                                data-bs-toggle="dropdown">
                                                Created Date
                                            </a>
                                            <ul class="dropdown-menu  dropdown-menu-end p-3">
                                    ...
                                    <div class="row align-items-center mb-3 row-gap-3">
                                        <div class="col-lg-4 col-sm-6">
                                            <div class="accordion-header" id="headingTwo">
                                                <div class="accordion-button bg-transparent" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="d-flex align-items-center w-100">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="badge bg-light text-dark rounded-pill ms-2">15</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-sm-6">
                                            <div class="d-flex align-items-center justify-content-sm-end">
                                                <a href="#" class="btn btn-light me-2" data-bs-toggle="modal"
                                                    ...
                                                    New</a>
                                                <a href="#" class="btn btn-white border">See All <i
                                                    ...
                                                    <div class="row align-items-center row-gap-3">
                                                        ...
                                                        <div class="col-lg-6 col-md-5">
                                                            <div
                                                                ...
                                                                <span
                                                                    class="badge badge-success bg-success me-3">Projects</span>
                                                                <span
                                                                    class="badge badge-soft-danger d-inline-flex align-items-center me-3"><i
                                                    ...
                                                    <div class="row align-items-center row-gap-3">
                                                        ...
                                                        <div class="col-lg-6 col-md-5">
                                                            <div
                                                                class="d-flex align-items-center justify-content-md-end flex-wrap row-gap-3">
                                                                <span
                                                                    class="badge bg-danger bg-danger me-3">Internal</span>
                                                                <span
                                                    ...
                                                    <div class="row align-items-center row-gap-3">
                                                        ...
                                                        <div class="col-lg-6 col-md-5">
                                                            <div
                                                                ...
                                                                <span
                                                                    class="badge badge-soft-info d-flex align-items-center me-3"><i
                                                ...
                                                <div class="accordion-button bg-transparent" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="d-flex align-items-center w-100">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="badge bg-light text-dark rounded-pill ms-2">05</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    class="me-2 rating-select d-flex align-items-center"><i
                                                                        class="ti ti-star"></i></span>
                                                                <div class="strike-info">
                                                                    <h4 class="fs-14 mb-0">Coordinate with department head
                                                                        on progress</h4>
                                                                </div>
                                                                <span
                                                                    class="badge bg-transparent-dark text-dark rounded-pill ms-2"><i
                                                ...
                                                <div class="accordion-button bg-transparent" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="d-flex align-items-center w-100">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="badge bg-light text-dark rounded-pill ms-2">24</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="accordion-button bg-transparent" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="d-flex align-items-center w-100">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <h5 class="fw-semibold">High</h5>
                                                            <span
                                                                class="badge text-dark bg-light rounded-pill ms-2">15</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="accordion-button bg-transparent" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="d-flex align-items-center w-100">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <h5 class="fw-semibold">Medium</h5>
                                                            <span
                                                                class="badge text-dark bg-light rounded-pill ms-2">05</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="accordion-button bg-transparent" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="d-flex align-items-center w-100">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <h5 class="fw-semibold">Low</h5>
                                                            <span
                                                                class="badge text-dark bg-light rounded-pill ms-2">24</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
