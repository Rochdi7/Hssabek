                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <h6 class="fs-16 fw-semibold mb-0 d-inline-flex flex-wrap gap-2 flex-column">
                                            $8,500,00 <span class="badge badge-soft-success badge-xs">+5.62% <i
                                                    class="isax isax-arrow-up-15 ms-1"></i></span></h6>
                                    </div>
                                    <div>
                                        <span
                                            class="badge badge-soft-primary border p-2 border-primary rounded-circle d-inline-flex align-items-center justify-content-center">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <h6 class="fs-16 fw-semibold mb-0 d-inline-flex flex-wrap gap-2 flex-column">Earbuds
                                            <span class="badge badge-soft-success badge-xs">+11.4% <i
                                                    class="isax isax-arrow-up-15 ms-1"></i></span></h6>
                                    </div>
                                    <div>
                                        <span
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <h6 class="fs-16 fw-semibold mb-0 d-inline-flex flex-wrap gap-2 flex-column">$12,500
                                            <span class="badge badge-soft-success badge-xs">+8.52% <i
                                                    class="isax isax-arrow-up-15 ms-1"></i></span></h6>
                                    </div>
                                    <div>
                                        <span
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <h6 class="fs-16 fw-semibold mb-0 d-inline-flex flex-wrap gap-2 flex-column">$15,000
                                            <span class="badge badge-soft-success badge-xs">+7.45% <i
                                                    class="isax isax-arrow-up-15 ms-1"></i></span></h6>
                                    </div>
                                    <div>
                                        <span
