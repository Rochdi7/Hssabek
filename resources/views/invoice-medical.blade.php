            ...
            <div class="col-md-10 mx-auto">
                <div>
                    ...
                    <div class="d-flex align-items-start justify-content-between flex-wrap pb-3 overflow-hidden">
                        <div>
                            ...
                            <div class="d-inline-block inv-medical position-relative">
                                <p class="mb-0 text-white">Address : 15 Hodges Mews, High Wycombe HP12 3JL, United Kingdom.
                                </p>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center justify-content-between p-3">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <p class="mb-0 text-dark fw-bold">4 Balmy Beach Road, Owen Sound, Ontario, Canada
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="text-dark fw-medium text-end">
                                        <h6>Total</h6>
                                    </td>
                    ...
                    <div class="py-3 border-bottom border-dark">
                        <p class="text-dark text-center">Total amount ( in words): One Thousand Eight Hundred Fifteen
                            Dollars Only.</p>
                    </div>
