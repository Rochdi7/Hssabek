...
@section('title', 'Nouvelle Succursale')
@section('description', 'Ajouter une nouvelle succursale')
@section('content')
            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="mb-3">{{ __('Nouvelle succursale') }}</h5>
                                @if ($errors->any())
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('code') }}" placeholder="{{ __('Ex: SUC-01') }}">
                                                @error('code')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('is_default') is-invalid @enderror"
                                                    name="is_default">
                                                    <option value="0"
                                                        {{ old('is_default', '0') === '0' ? 'selected' : '' }}>{{ __('Non') }}</option>
                                                    <option value="1"
                                                        {{ old('is_default') === '1' ? 'selected' : '' }}>{{ __('Oui') }}</option>
                                                </select>
                                                @error('is_default')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('is_active') is-invalid @enderror"
                                                    name="is_active">
                                                    <option value="1"
                                                        {{ old('is_active', '1') === '1' ? 'selected' : '' }}>{{ __('Oui') }}</option>
                                                    <option value="0"
                                                        {{ old('is_active') === '0' ? 'selected' : '' }}>{{ __('Non') }}</option>
                                                </select>
                                                @error('is_active')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
