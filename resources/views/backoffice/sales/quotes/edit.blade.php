                                ...
                                <div class="extra-info">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-7">
                                            <div class="mb-3">
                                                        <div class="col-12">
                                                            <input type="text" class="form-control" name="chantier_location" value="{{ old('chantier_location', $quote->chantier_location) }}" placeholder="{{ __('Localisation du chantier') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="addition" value="{{ old('addition', ($quote->bill_to_snapshot['addition'] ?? '')) }}" placeholder="{{ __('Chantier, référence projet, etc.') }}">
                                                </div>
