            ...
            <div class="row">
                <div class="col-md-9 mx-auto">
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h6 class="mb-3">Détails du remboursement</h6>

                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <table class="table table-borderless">
                                            <tr>
                                                <td class="text-muted fw-medium" style="width: 40%;">Réf. fournisseur</td>
                                                <td>{{ $refund->provider_refund_id ?? '—' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-muted fw-medium">Paiement lié</td>
                                                <td>
                                                    @if ($refund->payment)
                                ...
                                @if ($refund->payment && $refund->payment->paymentMethod)
                                    <div class="mb-3">
                                        <label class="form-label text-muted fw-medium">Méthode de paiement</label>
