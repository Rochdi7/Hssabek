...
@section('description', 'Créer un nouveau remboursement')
@section('content')
            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="mb-3">{{ __('Nouveau remboursement') }}</h5>
                                @if ($errors->any())
                                ...
                                <form action="{{ route('bo.sales.refunds.store') }}" method="POST">
                                    ...
                                    <div class="row gx-3">
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Paiement') }} <span class="text-danger ms-1">*</span></label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group position-relative">
                                                    <input type="text"
                                                        ...
                                                        name="refunded_at" value="{{ old('refunded_at', date('d-m-Y')) }}"
