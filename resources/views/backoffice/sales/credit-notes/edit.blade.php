                                                ...
                                                <div>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane fade" id="terms" role="tabpanel">
                                                            ...
                                                            <textarea name="terms" class="form-control" rows="3">{{ old('terms', $creditNote->terms) }}</textarea>
                                                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('add-item-btn').addEventListener('click', function() {
                ...
                row.innerHTML = `
                    ...
                    <td><input type="number" name="items[${itemIndex}][tax_rate]" class="form-control item-tax" value="0" min="0" max="100" step="0.01" style="min-width: 80px;"></td>
