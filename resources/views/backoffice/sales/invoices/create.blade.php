                            ...
                            <div class="card-body">
                                ...
                                <div class="items-details">
                                    ...
                                    <div class="table-responsive rounded border-bottom-0 border mb-3">
                                        <table class="table table-nowrap add-table m-0" id="items-table" style="min-width: 700px;">
                                            <thead style="background-color: #1B2850; color: #fff;">
                                                <tr>
                                                    <th style="color: #fff; min-width: 150px;">{{ __('Libellé') }}</th>
                                                    <th style="color: #fff; min-width: 80px;">{{ __('Quantité') }}</th>
                                                    <th style="color: #fff; min-width: 80px;">{{ __('Unité') }}</th>
                                                    <th style="color: #fff; min-width: 100px;">{{ __('Prix unitaire') }}</th>
                                                    <th style="color: #fff; min-width: 130px;">{{ __('Remise') }}</th>
                                                    <th style="color: #fff; min-width: 110px;" class="tax-col">{{ __('Taxe (%)') }}</th>
                                                    <th style="color: #fff; min-width: 90px;">{{ __('Montant') }}</th>
                                                    <th style="color: #fff; min-width: 40px;"></th>
                                                </tr>
                                            </thead>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const checkedRadioInv = document.querySelector('[name="item_type_filter"]:checked');
            if (checkedRadioInv) checkedRadioInv.dispatchEvent(new Event('change'));
