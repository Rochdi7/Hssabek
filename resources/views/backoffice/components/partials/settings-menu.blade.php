            ...
            <ul>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"
                        class="{{ request()->routeIs('bo.account.settings.*', 'bo.settings.security.*', 'bo.settings.notifications.*') ? 'active subdrop' : '' }}">
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('bo.settings.locale.edit') }}"
                                class="{{ request()->routeIs('bo.settings.locale.*') ? 'active' : '' }}">{{ __('Localisation') }}</a></li>
