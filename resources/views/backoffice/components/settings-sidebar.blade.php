                                    ...
                                    <ul>
                                        <li class="submenu">
                                            <a href="javascript:void(0);"
                                                class="{{ Request::is('backoffice/account/settings*', 'security-settings', 'plans-settings', 'notifications-settings', 'integrations-settings') ? 'active subdrop' : '' }}">
                                            ...
                                            <ul>
                                                <li><a href="{{ route('bo.account.settings.edit') }}"
                                                        class="{{ Request::is('backoffice/account/settings*') ? 'active' : '' }}">Account
                                                        Settings</a></li>
                                        ...
                                        <li class="submenu">
                                            <a href="javascript:void(0);"
                                                class="{{ Request::is('company-settings', 'localization-settings', 'prefixes-settings', 'seo-setup', 'language-settings', 'language-setting2', 'language-setting3', 'maintenance-mode', 'authentication-settings', 'ai-configuration', 'appearance-settings', 'plugin-manager', 'preference-settings') ? 'active subdrop' : '' }}">
                                        ...
                                        <li class="submenu">
                                            <a href="javascript:void(0);"
                                                class="{{ Request::is('invoice-settings', 'invoice-templates-settings', 'esignatures', 'barcode-settings', 'thermal-printer', 'custom-fields', 'sass-settings') ? 'active subdrop' : '' }}">
                                        ...
                                        <li class="submenu">
                                            <a href="javascript:void(0);"
                                                class="{{ Request::is('payment-methods', 'bank-accounts-settings', 'tax-rates', 'currencies') ? 'active subdrop' : '' }}">
                                        ...
                                        <li class="submenu">
                                            <a href="javascript:void(0);"
                                                class="{{ Request::is('email-settings', 'email-templates', 'sms-gateways', 'gdpr-cookies') ? 'active subdrop' : '' }}">
                                        ...
                                        <li class="submenu">
                                            <a href="javascript:void(0);"
                                                class="{{ Request::is('custom-css', 'custom-js', 'sitemap', 'clear-cache', 'storage', 'cronjob', 'system-backup', 'database-backup', 'system-update') ? 'active subdrop' : '' }}">
