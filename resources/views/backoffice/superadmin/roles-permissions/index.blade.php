                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                    ...
                    <div>
                        <a href="{{ route('sa.access.permissions.index') }}"
                            ...
                            <i class="isax isax-shield-tick me-1"></i>{{ __('Gérer les permissions') }}
                        </a>
                    </div>
                    <div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <form method="GET" action="{{ route('sa.access.roles.index') }}">
                        ...
                        <select name="tenant_id" class="form-select mb-3" onchange="this.form.submit()">
                            <option value="">{{ __('Tous les Tenants (+ Global)') }}</option>
                ...
                <div class="col-md-6 d-flex justify-content-end align-items-start">
                    @include('backoffice.components.column-toggle', [
                        'columns' => [__('Rôle'), __('Tenant'), __('Créé le')],
                    ])
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="table-responsive table-nowrap">
                <table class="table border mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">{{ __('Aucun rôle trouvé.') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('sa.access.roles.store') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">{{ __('Tenant (laisser vide pour global)') }}</label>
                            <select name="tenant_id" class="form-select">
                                <option value="">{{ __('Global (aucun tenant)') }}</option>
                                @foreach ($tenants as $tenant)
