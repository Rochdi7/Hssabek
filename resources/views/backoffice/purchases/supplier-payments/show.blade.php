            ...
            <div class="row">
                <div class="col-md-9 mx-auto">
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h6 class="mb-3">Détails du paiement fournisseur</h6>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                <td class="text-muted fw-medium">Fournisseur</td>
                                ...
                                @if ($supplierPayment->allocations && $supplierPayment->allocations->count())
                                    <h6 class="mb-3 mt-4">Allocations aux factures fournisseur</h6>
