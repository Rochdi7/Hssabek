                    ...
                    <div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h6><a href="{{ route('bo.finance.money-transfers.index') }}"><i
                                        class="isax isax-arrow-left me-2"></i>{{ __('Transferts entre comptes') }}</a></h6>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <h5 class="mb-3">{{ __('Modifier le transfert') }}</h5>
                                ...
                                <form action="{{ route('bo.finance.money-transfers.update', $moneyTransfer) }}"
                                    ...
                                    <div class="row gx-3">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Compte source') }} <span
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Compte destination') }} <span
                                                        class="text-danger ms-1">*</span></label>
                                                <select
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Date du transfert') }} <span
                                                        class="text-danger ms-1">*</span></label>
                                                <input type="text"
