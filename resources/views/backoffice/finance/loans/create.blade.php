...
@section('description', 'Enregistrer un nouveau prêt')
@section('content')
            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="mb-3">{{ __('Nouveau prêt') }}</h5>
                                ...
                                <form action="{{ route('bo.finance.loans.store') }}" method="POST">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('lender_type') is-invalid @enderror"
                                                    ...
                                                    <option value="">{{ __('— Sélectionner —') }}</option>
                                                    <option value="bank"
                                                        {{ old('lender_type') === 'bank' ? 'selected' : '' }}>{{ __('Banque') }}
                                                    </option>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="{{ __('Ex: Banque Populaire') }}">
                                                @error('lender_name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('status') is-invalid @enderror"
                                                    name="status">
                                                    <option value="active"
                                                        {{ old('status', 'active') === 'active' ? 'selected' : '' }}>{{ __('Actif') }}
                                                    </option>
                                                    <option value="closed"
                                                        {{ old('status') === 'closed' ? 'selected' : '' }}>{{ __('Terminé') }}
                                                    </option>
                                                    <option value="defaulted"
                                                        {{ old('status') === 'defaulted' ? 'selected' : '' }}>{{ __('Défaut') }}
                                                    </option>
                                                </select>
                                                @error('status')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between pt-4 border-top">
                                        ...
                                        <button type="submit" class="btn btn-primary">{{ __('Enregistrer le prêt') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
