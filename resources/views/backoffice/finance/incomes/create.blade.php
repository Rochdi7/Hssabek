...
@section('description', 'Enregistrer un nouveau revenu')
@section('content')
    <!-- ========================
                        Start Page Content
                    ========================= -->
            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="mb-3">{{ __('Nouveau revenu') }}</h5>
                                ...
                                <form action="{{ route('bo.finance.incomes.store') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group position-relative">
                                                    <input type="text"
                                                        ...
                                                        name="income_date" value="{{ old('income_date', date('d-m-Y')) }}"
                                    ...
                                    <div class="d-flex align-items-center justify-content-between pt-4 border-top">
                                        ...
                                        <button type="submit" class="btn btn-primary">{{ __('Enregistrer le revenu') }}</button>
                                    </div>
                                </form>
                            </div><!-- end card body -->
                        </div><!-- end card -->
