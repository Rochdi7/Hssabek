                    ...
                    <a href="{{ route('bo.reports.sales') }}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body text-center py-4">
                                ...
                                <h6>{{ __('Rapport des ventes') }}</h6>
                                <p class="text-muted mb-0">{{ __('Revenus, factures et meilleurs clients') }}</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('bo.reports.customers') }}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body text-center py-4">
                                ...
                                <h6>{{ __('Rapport des clients') }}</h6>
                                <p class="text-muted mb-0">{{ __('Activité clients et créances') }}</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('bo.reports.purchases') }}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body text-center py-4">
                                ...
                                <h6>{{ __('Rapport des achats') }}</h6>
                                <p class="text-muted mb-0">{{ __('Dépenses fournisseurs et factures') }}</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('bo.reports.finance') }}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body text-center py-4">
                                ...
                                <h6>{{ __('Rapport financier') }}</h6>
                                <p class="text-muted mb-0">{{ __('Revenus vs dépenses et bénéfice') }}</p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ route('bo.reports.inventory') }}" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body text-center py-4">
                                ...
                                <h6>{{ __("Rapport d'inventaire") }}</h6>
                                <p class="text-muted mb-0">{{ __('Niveaux de stock et alertes') }}</p>
                            </div>
                        </div>
                    </a>
                </div>
