    ...
    <div class="page-wrapper">
        <div class="content content-two">
            ...
            <div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
                <div>
                    <h6>{{ __('Inviter un utilisateur') }}</h6>
                </div>
                ...
                <div class="col-xl-8 col-lg-10">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="fs-14 fw-semibold mb-0">{{ __('Envoyer une invitation') }}</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('bo.users.invite.store') }}">
                                ...
                                <p class="text-muted fs-12 mb-3">
                                    {{ __("Un e-mail sera envoyé à l'adresse indiquée avec un lien d'invitation valable 7 jours.") }}
                                </p>

                                <div class="d-flex align-items-center justify-content-between mt-3">
                                    <a href="{{ route('bo.users.index') }}" class="btn btn-outline-white">{{ __('Annuler') }}</a>
                                    <button type="submit" class="btn btn-primary">
                                        <i class="isax isax-sms me-1"></i>{{ __("Envoyer l'invitation") }}
                                    </button>
                                </div>
                            </form>
                        </div>
