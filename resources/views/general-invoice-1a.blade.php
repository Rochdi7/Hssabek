                ...
                <div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <div class="p-4 invoice-design-6">
                                        ...
                                        <p class="text-dark">Address : 15 Hodges Mews, <br> High Wycombe HP12 3JL, United
                                            Kingdom.</p>
                                    </div>
                                </div>
                            </div> <!-- end col -->
                            <div class="col-lg-8">
                                <div class="text-lg-end mb-2">
                                    <div class="mb-1"><img src="{{ URL::asset('build/img/invoice-logo.svg') }}"
                                            alt=""></div>
                    ...
                    <div class="table-responsive mb-3">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6" class="text-end">Total amount ( in words): One Thousand Eight Hundred
                                        Fifteen Dollars Only.</td>
                                </tr>
                            </tbody>
                        </table> <!-- end table -->
                    </div>
                    <div class="d-flex align-items-center justify-content-between flex-wrap border-bottom">
                        ...
                        <div class="mb-3">
                            ...
                            <p class="text-dark">2. We are not the manufactures, company will stand for warrenty as per
