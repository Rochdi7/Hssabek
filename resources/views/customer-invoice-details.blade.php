                ...
                <div class="col-md-10 mx-auto">
                    <div>
                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                            <h6><a href="{{ url('customer-invoices') }}"><i class="isax isax-arrow-left me-2"></i>Invoice
                                    (Customer)</a></h6>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="bg-light p-4 rounded position-relative mb-3">
                                    ...
                                    <div
                                        class="d-flex align-items-center justify-content-between border-bottom flex-wrap mb-3 pb-2">
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-3">
                                                ...
                                                <span><img src="{{ URL::asset('build/img/icons/not-paid.png') }}"
                                                        alt="User Img" width="48" height="48"></span>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                                ...
                                                <div class="bg-white rounded p-3">
                                                    <div class="d-flex align-items-center mb-1">
                                                        <span class="avatar avatar-md border border-gray-100 border-2 me-2">
                                                            <img src="{{ URL::asset('build/img/invoice/timesquare.png') }}"
                                                                alt="User Img">
                                                        </span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p>One thousand eight hundred &amp; eleven dollars &amp; twelve cents.
                                                    </p>
                                                </div>
                                            </div>
                                        </div><!-- end col -->
            ...
            <form action="#">
                ...
                <div class="mb-3">
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <span class="d-flex align-items-center text-dark" data-bs-dismiss="offcanvas"
                            data-bs-toggle="modal" data-bs-target="#add_card"><i
                                class="isax isax-add-circle5 text-primary me-1"></i>Add</span>
                    </div>
                ...
                <div class="mb-2">
                    <a href="#" class="btn btn-primary w-100 " data-bs-toggle="modal"
                        data-bs-target="#success_modal">Pay Now $596</a>
                </div>
