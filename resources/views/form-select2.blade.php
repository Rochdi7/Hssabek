            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Select2 gives you a customizable select box with support for searching,
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <p class="text-muted">Set <code>data-choices
                                                    data-choices-limit="Required Limit" data-choices-removeItem</code>
                                                attribute.</p>
