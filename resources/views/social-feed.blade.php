                                    ...
                                    <div>
                                        <div class="more-menu-3">
                                            <a href="javscript:void(0);"
                                                class="fw-medium d-flex align-items-center justify-content-between text-dark py-1 mb-2">
                                                <span class="d-inline-flex align-items-center">
                                                    <img src="{{ URL::asset('build/img/icons/liked-page-04.svg') }}"
                                                        class="me-2" alt="Img">I Am Techie
                                                </span>
                                                <span class="btn btn-icon btn-sm"><i class="ti ti-thumb-down"></i></span>
                                            </a>
                                        </div>
                    ...
                    <div>
                        ...
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-1"><a href="javascript:void(0);">Richard Smith <i
                                                        class="ti ti-circle-check-filled text-success"></i></a></h6>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <img src="{{ URL::asset('build/img/social/social-feed-01.jpg') }}" class="rounded"
                                        alt="Img">
                                </div>
                                <div class="social-gallery-slider owl-carousel mb-3">
                                    <a href="{{ URL::asset('build/img/social/gallery-big-01.jpg') }}"
                                        data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ URL::asset('build/img/social/gallery-01.jpg') }}" class="rounded"
                                            alt="img">
                                        <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                    </a>
                                    <a href="{{ URL::asset('build/img/social/gallery-big-02.jpg') }}"
                                        data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ URL::asset('build/img/social/gallery-02.jpg') }}" class="rounded"
                                            alt="img">
                                        <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                    </a>
                                    <a href="{{ URL::asset('build/img/social/gallery-big-03.jpg') }}"
                                        data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ URL::asset('build/img/social/gallery-03.jpg') }}" class="rounded"
                                            alt="img">
                                        <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                    </a>
                                    <a href="{{ URL::asset('build/img/social/gallery-big-04.jpg') }}"
                                        data-fancybox="gallery" class="gallery-item">
                                        <img src="{{ URL::asset('build/img/social/gallery-04.jpg') }}" class="rounded"
                                            alt="img">
                                        <span class="avatar avatar-md avatar-rounded"><i class="ti ti-eye"></i></span>
                                    </a>
                                    <a href="{{ URL::asset('build/img/social/gallery-big-01.jpg') }}"
                                ...
                                <div class="d-flex align-items-start">
                                    <a href="javascript:void(0);" class="avatar avatar-rounded me-2 flex-shrink-0"><img
                                            src="{{ URL::asset('build/img/users/user-04.jpg') }}" alt="Img"></a>
                            ...
                            <div class="card-header border-0 pb-0">
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-1"><a href="javascript:void(0);">Jason Heier <i
                                                        class="ti ti-circle-check-filled text-success"></i></a></h6>
                                            <p class="d-flex align-items-center">
                                ...
                                <div class="card shadow-none mb-3">
                                    <div class="card-img card-img-hover rounded-0">
                                        <a href="javascript:void(0);" class="rounded-top"><img
                                                src="{{ URL::asset('build/img/social/social-feed-02.jpg') }}"
                        ...
                        <div class="card">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2"><img
                                                ...
                                                alt="Img"></span>
                                        <div>
                                            <h6 class="mb-1"><a href="javascript:void(0);">Sophie Headrick <i
                                                        class="ti ti-circle-check-filled text-success"></i></a></h6>
                                            <p class="d-flex align-items-center">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <img src="{{ URL::asset('build/img/social/social-feed-03.jpg') }}" class="rounded"
                                        alt="Img">
                                </div>
                                <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                                    <div class="d-flex align-items-center flex-wrap row-gap-3">
                                ...
                                <div class="d-flex align-items-start">
                                    <span class="avatar avatar-rounded me-2 flex-shrink-0"><img
                                            src="{{ URL::asset('build/img/users/user-05.jpg') }}" alt="Img"></span>
                                    <input type="text" class="form-control" placeholder="Enter Comments">
                                </div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                    ...
                                    <div>
                                        <a href="javascript:void(0);" class="btn btn-white w-100 border">View All <i
                        ...
                        <div class="card-body">
                            <div class="card-img card-img-hover mb-3">
                                <a href="javascript:void(0);" class="rounded"><img
                                        src="{{ URL::asset('build/img/social/social-feed-04.jpg') }}" class="rounded"
                                        alt="Img"></a>
                            </div>
                            <h6 class="text-center fs-14"><a href="javascript:void(0);">Enjoy Unlimited Access on a small
                                    price monthly.</a></h6>
                            <div class="mt-3">
                                <a href="javascript:void(0);" class="btn btn-white w-100 border">Upgrade Now <i
                                        class="ti ti-arrow-right ms-2"></i></a>
                            </div>
                        </div><!-- end card body -->
                    </div><!-- end card -->
