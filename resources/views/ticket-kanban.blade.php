        ...
        <div class="content content-two">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ url('ticket-kanban') }}"
                            class="btn btn-primary p-2 d-inline-flex align-items-center justify-content-center me-1"><i
                    ...
                    <div class="dropdown me-1">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="tab"
                                    data-bs-target="#tab">Download as PDF</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="tab"
                                    data-bs-target="#tab">Download as Excel</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <ul class="nav nav-tabs nav-bordered mb-3 gap-2">
                <li class="nav-item"><a class="nav-link active" href="javascript:void(0);" data-bs-toggle="tab"
                        data-bs-target="#All_tab">All</a></li>
                <li class="nav-item"><a class="nav-link" href="javascript:void(0);" data-bs-toggle="tab"
                        data-bs-target="#Open_tab">Open</a></li>
                <li class="nav-item"><a class="nav-link" href="javascript:void(0);" data-bs-toggle="tab"
                        data-bs-target="#Resolved_tab">Resolved</a></li>
                <li class="nav-item"><a class="nav-link" href="javascript:void(0);" data-bs-toggle="tab"
                        data-bs-target="#Pending_tab">Pending</a></li>
                <li class="nav-item"><a class="nav-link" href="javascript:void(0);" data-bs-toggle="tab"
                        data-bs-target="#Closed_tab">Closed</a></li>
            </ul>

            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="All_tab" role="tabpanel">
                    <div
                        class="d-flex align-items-start overflow-auto project-status flex-wrap flex-lg-nowrap flex-md-nowrap">
                        <div class="p-3 rounded bg-light w-100 me-3">
                            <div class="bg-white border p-2 rounded mb-2">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span
                                            class="badge bg-light rounded-circle fs-10 avatar avatar-xs text-dark">5</span>
                                    </div>
                                    <div class="dropdown">
                                        <a href="javascript:void(0);"
                                            class="d-inline-flex align-items-center btn btn-white border-0"
                                            data-bs-toggle="dropdown">
                                    ...
                                    <div class="card kanban-card mb-2">
                                        <div class="card-body">
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="badge bg-light badge-sm border-info d-flex align-items-center justify-content-center text-info fs-12 fw-medium">Low</span>
                                                </div>
                                                <div class="dropdown">
                                                    <a href="javascript:void(0);"
                                                        class="d-inline-flex align-items-center bg-white rounded-circle p-1 border justify-content-center"
                                                        data-bs-toggle="dropdown">
                                                        <i
                                                            class="isax isax-more d-flex align-items-center justify-content-center text-gray-5"></i>
                                                    </a>
                                                    <ul class="dropdown-menu dropdown-menu-end p-3">
                                                        <li>
                                                            <a href="javascript:void(0);" class="dropdown-item rounded-1"
                                            ...
                                            <div
                                                class="d-flex align-items-start mb-3 border-bottom border-1 border-light pb-3 mb-3 flex-column">
                                                <h6 class="d-flex align-items-center mb-3">Support For Theme</h6>

                                                <div class="d-flex align-items-center gap-3">
                                                    <span class="badge badge-sm badge-soft-light border fs-10 text-dark">
                                                        #1234</span>
                                                    <span
                                                        class="badge badge-sm badge-soft-primary fs-10 text-primary fw-medium d-flex align-items-center justify-content-center">
                                                        <i class="fa-solid fa-circle text-primary me-1 fs-5"></i>
                                                        Open</span>
                                                </div>
                                    ...
                                    <div class="card kanban-card mb-2">
                                        <div class="card-body">
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span
                                                        class="badge bg-soft-orange badge-sm border d-flex align-items-center justify-content-center text-orange fs-12 fw-medium text-danger">Medium</span>
                                                </div>
                                                <div class="dropdown">
                                                    <a href="javascript:void(0);"
                                                        class="d-inline-flex align-items-center bg-white rounded-circle p-1 border justify-content-center"
                            ...
                            <div class="pt-2">
                                <a href="#"
                                    class="btn btn-white bg-white border d-flex align-items-center justify-content-center"
                                    data-bs-toggle="modal" data-bs-target="#add_modal">
                        ...
                        <div class="p-3 rounded bg-light w-100 me-3">
                            <div class="bg-white border p-2 rounded mb-2">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <span class="bg-transparent-primary p-1 d-flex rounded-circle me-2"><span
                                                class="bg-primary rounded-circle d-block p-1"></span></span>
                                        <h6 class="me-2 fs-16 fw-semibold">Pending</h6>
                                        <span
                                            class="badge bg-light rounded-circle fs-10 avatar avatar-xs text-dark">9</span>
                                    </div>
                                    <div class="dropdown">
                                        <a href="javascript:void(0);"
                                            class="d-inline-flex align-items-center btn btn-white border-0"
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    <span class="badge badge-sm badge-soft-light border fs-10 text-dark">
                                                        #1234</span>
                                                    <span
                                                        class="badge badge-sm badge-soft-warning fs-10 text-warning fw-medium d-flex align-items-center justify-content-center">
                                                        <i class="fa-solid fa-circle text-warning me-1 fs-5"></i>
                                                        Pending</span>
                                                </div>
                            ...
                            <div class="bg-white border p-2 rounded mb-2">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span
                                            class="badge bg-light rounded-circle fs-10 avatar avatar-xs text-dark">7</span>
                                    </div>
                                    <div class="dropdown">
                                        <a href="javascript:void(0);"
                                            class="d-inline-flex align-items-center btn btn-white border-0"
                        ...
                        <div class="p-3 rounded bg-light w-100">
                            <div class="bg-white border p-2 rounded mb-2">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <span class="bg-transparent-success p-1 d-flex rounded-circle me-2"><span
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    <span class="badge badge-sm badge-soft-light border fs-10 text-dark">
                                                        #1234</span>
                                                    <span
                                                        class="badge badge-sm badge-soft-warning fs-10 text-warning fw-medium">
                                                        <i class="fa-solid fa-circle text-warning me-1 fs-6"></i>
                                                        Pending</span>
                                                </div>
                ...
                <div class="tab-pane fade" id="Resolved_tab" role="tabpanel">
                    <div
                        class="d-flex align-items-start overflow-auto project-status pb-3 flex-wrap flex-lg-nowrap flex-md-nowrap">
                        <div class="p-3 rounded bg-light w-100">
                            <div class="bg-white border p-2 rounded mb-2">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
            ...
            <form action="#">
                <div class="mb-3">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu shadow-lg w-100 dropdown-info">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <a href="javascript:void(0);" data-bs-toggle="tab" data-bs-target="#tab"
                ...
                <div class="offcanvas-footer">
                    <div class="row g-2">
                        <div class="col-6">
                            <a href="javascript:void(0);" data-bs-toggle="tab" data-bs-target="#tab"
                                class="btn btn-outline-white w-100">Reset</a>
                        </div>
                        <div class="col-6">
