                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="card position-relative shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="progress progress-xs mb-2 progress-animate" role="progressbar" aria-valuenow="25"
                ...
                <table class="table table-nowrap datatable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00025</a>
                            </td>
                            <td>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                            data-bs-toggle="modal" data-bs-target="#view_invoice"><i
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                                                class="isax isax-stop-circle me-2"></i>Stop Recurring</a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00024</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00023</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00022</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                            ...
                            <td>
                                <span class="badge badge-soft-info d-inline-flex align-items-center">Partially Paid<i
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00021</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                            ...
                            <td>
                                <span class="badge badge-soft-danger d-inline-flex align-items-center">Uncollectable <i
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00020</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00019</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00018</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00017</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00016</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00015</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00014</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00013</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="link-default" data-bs-toggle="modal"
                                    data-bs-target="#view_invoice">INV00012</a>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('customer-details') }}"
