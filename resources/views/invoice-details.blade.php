                ...
                <div class="col-md-10 mx-auto">
                    <div>
                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                            <h6><a href="{{ url('invoices') }}"><i class="isax isax-arrow-left me-2"></i>Invoice (Admin)</a>
                            </h6>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap row-gap-3">
                                                ...
                                                <span><img src="{{ URL::asset('build/img/icons/not-paid.png') }}"
                                                        alt="img" width="48" height="48"></span>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="row gy-3 position-relative z-1">
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <div>
                                                    <p class="mb-1">Invoice Number : <span
                                                            class="text-dark">INV215654</span></p>
                                                    <p class="mb-1">Issued On : <span class="text-dark">25 Jan 2025</span>
                                                    </p>
                                                    <p class="mb-1">Due Date : <span class="text-dark">31 Jan 2025</span>
                                                    </p>
                                                    <p class="mb-1">Recurring Invoice : <span
                                                            class="text-dark">Monthly</span></p>
                                            ...
                                            <div>
                                                ...
                                                <div class="bg-white rounded p-3">
                                                    <div class="d-flex align-items-center mb-1">
                                                        <img src="{{ URL::asset('build/img/icons/billing-to-image.svg') }}"
                                                            alt="img" class="avatar avatar-lg me-2">
                                                        <div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex align-items-center p-4 mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        <p class="mb-1">Bank Name : <span class="text-dark">ABC
                                                                Bank</span></p>
                                                        <p class="mb-1">Account Number : <span
                                                                class="text-dark">782459739212</span></p>
                                                        <p class="mb-1">IFSC Code : <span
                                                                class="text-dark">ABC0001345</span></p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="text-lg-end mb-3">
                                            <span><img src="{{ URL::asset('build/img/icons/sign.png') }}"
                                                    class="sign-dark" alt="img"></span>
                                ...
                                <div
                                    class="bg-light d-flex align-items-center justify-content-between p-4 rounded card-bg">
                                    <div>
                                        <h6 class="fs-14 fw-semibold mb-1">Dreams Technologies Pvt Ltd.,</h6>
                                        <p>15 Hodges Mews, High Wycombe HP12 3JL, United Kingdom</p>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <p class="d-flex align-items-center">Days <span class="badge badge-danger ms-2">Due in
                                            8 days</span></p>
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <ul class="activity-feed bg-light rounded">
                        <li class="feed-item timeline-item">
                            <p class="mb-1">Status Changed to <span class="text-dark fw-semibold">Partially Paid</span>
                            </p>
                            <div class="invoice-date"><span><i class="isax isax-calendar me-1"></i>17 Jan 2025</span>
                            </div>
                        </li>
                        <li class="feed-item timeline-item">
                            <p class="mb-1"><span class="text-dark fw-semibold">$300 </span> Partial Amount Paid on
                                <span class="text-dark fw-semibold">Paypal</span></p>
                            <div class="invoice-date"><span><i class="isax isax-calendar me-1"></i>16 Jan 2025</span>
                            </div>
                        </li>
                        <li class="feed-item timeline-item">
                            <p class="mb-1"><span class="text-dark fw-semibold">John Smith </span> Created <span
                                    class="text-dark fw-semibold">Invoice</span><a href="#"
                                    class="text-primary">#INV1254</a></p>
                            <div class="invoice-date"><span><i class="isax isax-calendar me-1"></i>16 Jan 2025</span>
                            </div>
                        </li>
                    </ul>
