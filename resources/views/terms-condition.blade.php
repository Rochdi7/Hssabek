            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card mb-0">
                        <!-- card body start -->
                        <div class="card-body">
                            <p class="mb-3">Welcome to Hssabek. These Terms & Conditions outline the rules and guidelines
                                for using our website, mobile application, and related services. By accessing or using any
                                part of Hssabek, you acknowledge that you have read,
                                ...
                                of these Terms, you must refrain from using our services. Your continued use of Hssabek
                            ...
                            <p class="mb-3">To use Hssabek, you must be at least 18 years old or the legal age of majority
                            ...
                            <p class="mb-3">You are solely responsible for maintaining the confidentiality and security of
                                your Hssabek account credentials. Any activity that occurs under your account is your
                            ...
                            <p class="mb-3">You agree to use Hssabek solely for lawful purposes. Engaging in fraudulent,
                            ...
                            <p class="mb-3">All content, features, and functionality of Hssabek, including but not limited
                                to logos, software, design, and graphics, are the exclusive property of Hssabek or its
                                ...
                                of any Hssabek material is strictly prohibited and may result in legal action.</p>
                            <h6 class="fs-16 fw-semibold mb-3">Payments and Billing</h6>
                            <p class="mb-3">By subscribing to paid features on Hssabek, you agree to the pricing, billing
                            ...
                            <p class="mb-3">We reserve the right to suspend or terminate your access to Hssabek at any
                                ...
                                negatively impacts the security, functionality, or integrity of Hssabek and its services.
                            </p>
                            <h6 class="fs-16 fw-semibold mb-3">Disclaimers</h6>
                            <p class="mb-3">Hssabek is provided "as is" and "as available" without any warranties. We do
                                ...
                                that may occur during your use of our services. By using Hssabek, you acknowledge these
                                limitations and use it your own risk.</p>
                            <h6 class="fs-16 fw-semibold mb-3">Limitation of Liability</h6>
                            <p class="mb-3">To the fullest extent permitted by law, Hssabek is not liable for any
