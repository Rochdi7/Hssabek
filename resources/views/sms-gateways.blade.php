                                                ...
                                                <div class="card-body">
                                                    <div
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img src="{{ URL::asset('build/img/icons/nexmo-logo-icon.svg') }}"
                                                    ...
                                                    <p class="fs-13">Enables seamless communication through SMS, voice, and
                                                        APIs.</p>
                                                </div><!-- end card body -->
                                                <div class="card-footer">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <a href="javascript:void(0);"
                                                                class="btn btn-sm btn-dark rounded-2 d-inline-flex align-items-center justify-content-center p-1 me-2"
                                                                data-bs-toggle="modal" data-bs-target="#add_nexmo">
                                            ...
                                            <div class="card flex-fill">
                                                <div class="card-body">
                                                    <div
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img src="{{ URL::asset('build/img/icons/two-factor-icon.svg') }}"
                                                                    class="img-fluid" alt="img">
                                                            </span>
                                                        </div>
                                                        <span class="badge badge-soft-success d-flex align-items-center">
                                                    ...
                                                    <p class="fs-13">2Factor offers simple sms integration API and sample
                                                        code to send SMS</p>
                                                </div><!-- end card body -->
                                                <div class="card-footer">
                                                    <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="card flex-fill">
                                                <div class="card-body">
                                                    <div
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <span>
                                                                <img src="{{ URL::asset('build/img/icons/twilio-icon.svg') }}"
                                                                    class="img-fluid" alt="img">
                                                            </span>
                                                        </div>
                                                        <span
                                                            class="badge badge-soft-primary d-flex align-items-center text-gray-9">
                                                            <span class="badge-dot bg-dark me-1"></span>
                                                            Not Connected
                                                        </span>
                                                    </div>
                                                    <p class="fs-13">Twilio provides APIs for messaging, voice, and video
                                                        integration.</p>
                                                </div>
                                                <div class="card-footer">
                                                    <div class="d-flex justify-content-between align-items-center">
