                            ...
                            <div class="mb-3">
                                ...
                                <form action="{{ url('sass-settings') }}">
                                    <div class="card-body vh-100 border-bottom mb-3">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-8 col-sm-12">
                                                <label class="form-label fw-medium">Days between initial warning and
                                                    subscription ends</label>
                                            </div>
                                            <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-8 col-sm-12">
                                                <label class="form-label fw-medium">Maximum Free Domain A Subscriber Can
                                                    Create</label>
                                            </div>
                                            <div class="col-md-4 col-sm-12">
                                                <input type="text" class="form-control">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-9">
                                                <label class="form-label fw-medium">Auto approve Domain creation
                                                    request</label>
                                            </div>
                                            <div class="col-3 d-flex justify-content-end">
                                                <div class="form-check form-switch">
