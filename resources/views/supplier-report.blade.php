                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="card position-relative shadow-lg overflow-hidden">
                            <img src="{{ URL::asset('build/img/reports/supplier-report-01.svg') }}" alt="img"
                                class="img-fluid supplier-report-01">
                            <img src="{{ URL::asset('build/img/reports/supplier-report-02.svg') }}" alt="img"
                                class="img-fluid supplier-report-02">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="card shadow-lg position-relative overflow-hidden">
                            <img src="{{ URL::asset('build/img/reports/supplier-report-03.svg') }}" alt="img"
                                class="img-fluid supplier-report-01">
                            <img src="{{ URL::asset('build/img/reports/supplier-report-04.svg') }}" alt="img"
                                class="img-fluid supplier-report-02">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="card position-relative shadow-lg overflow-hidden">
                            <img src="{{ URL::asset('build/img/reports/supplier-report-05.svg') }}" alt="img"
                                class="img-fluid supplier-report-01">
                            <img src="{{ URL::asset('build/img/reports/supplier-report-06.svg') }}" alt="img"
                                class="img-fluid supplier-report-02">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="card position-relative shadow-lg overflow-hidden">
                            <img src="{{ URL::asset('build/img/reports/supplier-report-07.svg') }}" alt="img"
                                class="img-fluid supplier-report-01">
                            <img src="{{ URL::asset('build/img/reports/supplier-report-08.svg') }}" alt="img"
                                class="img-fluid supplier-report-02">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <div>
