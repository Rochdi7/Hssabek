                            ...
                            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img class="d-block img-fluid" src="{{ URL::asset('build/img/media/img-1.jpg') }}"
                                            alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid" src="{{ URL::asset('build/img/media/img-2.jpg') }}"
                                            alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid" src="{{ URL::asset('build/img/media/img-3.jpg') }}"
                                            alt="Third slide">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">You can also add the indicators to the carousel, alongside the controls,
                                too.</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img src="{{ URL::asset('build/img/media/img-1.jpg') }}" alt="Slide"
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{ URL::asset('build/img/media/img-2.jpg') }}" alt="Slide"
                                            class="d-block img-fluid">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{ URL::asset('build/img/media/img-3.jpg') }}" alt="Slide"
                                            class="d-block img-fluid">
                                        <div class="carousel-caption d-none d-md-block">
            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">Add <code>.carousel-fade</code> to your carousel to animate slides with a
                                fade transition instead of a slide.</p>
                            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block img-fluid"
                                            src="{{ URL::asset('build/img/media/img-1.jpg') }}" alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid"
                                            src="{{ URL::asset('build/img/media/img-2.jpg') }}" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid"
                                            src="{{ URL::asset('build/img/media/img-3.jpg') }}" alt="Third slide">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block img-fluid"
                                            src="{{ URL::asset('build/img/media/img-2.jpg') }}" alt="First slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid"
                                            src="{{ URL::asset('build/img/media/img-3.jpg') }}" alt="Second slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block img-fluid"
                                            src="{{ URL::asset('build/img/media/img-4.jpg') }}" alt="Third slide">
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{ URL::asset('build/img/media/img-2.jpg') }}" class="d-block w-100"
                                            alt="Slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{ URL::asset('build/img/media/img-3.jpg') }}" class="d-block w-100"
                                            alt="Slide">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="{{ URL::asset('build/img/media/img-4.jpg') }}" class="d-block w-100"
                                            alt="Slide">
                                    </div>
                                </div>
