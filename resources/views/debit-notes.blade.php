        ...
        <div class="content content-two">
            ...
            <div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                    ...
                    <div>
                        <a href="{{ url('add-debit-notes') }}" class="btn btn-primary d-flex align-items-center"><i
                                class="isax isax-add-circle5 me-1"></i>New Debit Note</a>
                    </div>
                </div>
            </div>
            <!-- Breadcrumb End -->
            ...
            <div class="mb-3">
                ...
                <div class="align-items-center gap-2 flex-wrap filter-info mt-3">
                    ...
                    <span class="tag bg-light border rounded-1 fs-12 text-dark badge"><span
                            class="num-count d-inline-flex align-items-center justify-content-center bg-success fs-10 me-1">5</span>$10,000
                    ...
                    <tbody>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="javascript:void(0);"
                                            ...
                                            data-bs-target="#view_modal"><i class="isax isax-eye me-2"></i>View</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('edit-debit-notes') }}"
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                                                class="isax isax-copy me-2"></i>Clone</a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="#"
                                        class="badge badge-soft-warning badge-sm d-inline-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="#"
                                        class="badge badge-soft-danger badge-sm d-inline-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-32.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-36.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-37.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-38.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-39.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);"
                                        class="avatar avatar-sm rounded-circle me-2 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/profiles/avatar-40.jpg') }}"
                                            class="rounded-circle" alt="img">
                                    </a>
                                    <div>
