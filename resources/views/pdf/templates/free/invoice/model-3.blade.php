...
{{-- ─── Items table ──────────────────────────────────────────── --}}
    ...
    <table style="width: 100%; margin-bottom: 0;">
        ...
        @endif
        @include('pdf.partials.tax-breakdown', ['doc' => $invoice, 'colspan' => 1, 'cellStyle' => 'totals-row', 'currency' => $currency])
        ...
        <div class="total-bar-inner">
            <table class="total-bar-table">
                <tr>
                    ...
                    <td style="width: 50%;">
                        <span class="total-value">{{ number_format($invoice->total, 2, ',', ' ') }} {{ $currency }}</span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    {{-- ─── Footer: Conditions + Bank details ────────────────────── --}}
    ...
    {{-- ─── Promo: demande de template personnalisé ────────────── --}}
    <div style="margin-top: 20px; text-align: center; padding: 10px 15px; background: #f8f9fa; border: 1px dashed #ccc; border-radius: 4px;">
        <p style="font-size: 9px; color: #666; margin: 0;">
            Vous utilisez un modèle gratuit. Demandez un template personnalisé à votre image sur
            <a href="http://127.0.0.1:8000/backoffice/settings/invoice-templates" style="color: #0d6efd; text-decoration: underline;">notre plateforme</a>
            ou contactez-nous directement sur
            <a href="https://wa.me/212632582096" style="color: #25D366; text-decoration: underline; font-weight: bold;">WhatsApp</a>.
        </p>
    </div>
