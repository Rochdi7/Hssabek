...
<div class="page">
    ...
    <div class="top-band">
        <table class="top-band-table">
            <tr>
                <td style="width: 65%;">
                    <div class="doc-title">{{ $pdfDocumentTitle ?? 'Devis' }}</div>
...
{{-- ─── Items table ──────────────────────────────────────── --}}
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{ $item->label }}
                        @if($item->description)<br><span style="color: #999; font-size: 9px;">{{ $item->description }}</span>@endif
                    </td>
                ...
                @if($quote->charges->count())
                    ...
                    <tr>
                        @if($hasMeasurement)
                        <td colspan="5">{{ $charge->label }} <span style="color: #999; font-size: 9px;">(frais)</span></td>
                        @else
        ...
        <div class="totals-wrapper">
            <table class="totals-table">
                ...
                @endif
                @include('pdf.partials.tax-breakdown', ['doc' => $quote, 'colspan' => 0, 'cellStyle' => 't-label', 'currency' => $currency])
