    ...
    <div class="content invoice-dark p-4">
        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="mb-3">
                    <h6><a href="{{ url('invoice-templates') }}" class="text-white"><i
                                class="isax isax-arrow-left me-1"></i>Back</a></h6>
                </div>
                <div>
                    <div
                        class="d-flex align-items-center justify-content-between bg-gray-9 p-3 rounded flex-wrap row-gap-3 mb-3">
                        <div>
                            <div class="mb-1"><img src="{{ URL::asset('build/img/invoice-logo-white.svg') }}"
                                    alt=""></div>
                        </div>
                        <div>
                    ...
                    <div class="border-bottom mb-3">
                        <h6 class="mb-2 fs-16">codesommet</h6>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <table class="table table-nowrap table-bordered table-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="text-dark fw-medium border-end-0 border-start-0">
                                        <h6>Total</h6>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6">Total amount ( in words): One Thousand Eight Hundred Fifteen Dollars
                                        Only.</td>
                                </tr>
                            </tbody>
                        </table> <!-- end table -->
