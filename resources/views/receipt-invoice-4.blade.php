                ...
                <div class="receipt-header">
                    <table class="table table-nowrap border-dashed mb-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2" class="fs-10 border-dashed p-1 text-dark fw-semibold">Total Payable :
                                </td>
                                <td class="border-0"></td>
                                <td colspan="2" class="fs-10 border-dashed p-1 text-dark text-end fw-semibold">$655.00
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <p class="text-center mb-2">12332345698234592384</p>
                    <img src="{{ URL::asset('build/img/barcode.svg') }}" class="img-fluid mb-2 pb-2 border-dashed"
                        alt="img">
