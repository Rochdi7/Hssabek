                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/icons/report-icon-01.svg') }}" alt=""
                                            class="low-stok-img">
                                    </div>
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="ms-2 badge badge-soft-success badge-xs">+5.62% <i
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/icons/report-icon-02.svg') }}" alt=""
                                            class="low-stok-img">
                                    </div>
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="ms-2 badge badge-soft-success badge-xs">+11.4% <i
                                                    class="isax isax-arrow-up-15 ms-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/icons/report-icon-03.svg') }}" alt=""
                                            class="low-stok-img">
                                    </div>
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="ms-2 badge badge-soft-success badge-xs">+8.52% <i
                                                    class="isax isax-arrow-up-15 ms-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card position-relative">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="me-3 flex-shrink-0">
                                        <img src="{{ URL::asset('build/img/icons/report-icon-04.svg') }}" alt=""
                                            class="low-stok-img">
                                    </div>
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <span class="ms-2 badge badge-soft-success badge-xs">+7.45% <i
                                                    class="isax isax-arrow-up-15 ms-1"></i></span>
                                        </div>
                                    </div>
