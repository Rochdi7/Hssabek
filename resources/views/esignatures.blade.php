                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-2">
                                                <a href="javascript:void(0);" data-bs-toggle="modal"
                                                    ...
                                                    class="btn btn-primary d-flex align-items-center"><i
                                                        class="isax isax-add-circle5 me-2"></i>New Signature</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table border">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ URL::asset('build/img/icons/sign-01.svg') }}"
                                                            alt="">
                                                    </td>
                                                    <td><a class="rounded-circle bg-light p-1" href="javascript:void(0);"><i
                                                                class="isax isax-star icon-active"></i></a></td>
                                                    <td>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                    ...
                                                                    data-bs-target="#edit_signatures"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ URL::asset('build/img/icons/sign-02.svg') }}"
                                                            alt="">
                                                    </td>
                                                    <td><a class="rounded-circle bg-light p-1" href="javascript:void(0);"><i
                                                                class="isax isax-star icon-active"></i></a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{ URL::asset('build/img/icons/sign-03.svg') }}"
                                                            alt="">
                                                    </td>
                                                    <td><a class="rounded-circle bg-light p-1" href="javascript:void(0);"><i
                                                                class="isax isax-star icon-active"></i></a></td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0);" class="text-dark">Ernesto
                                                            Janetts</a>
                                                    </td>
                                                    <td>
                                                        <img src="{{ URL::asset('build/img/icons/sign-04.svg') }}"
                                                            alt="">
                                                    </td>
                                                    <td><a class="rounded-circle bg-light p-1"
