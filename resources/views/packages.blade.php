                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                    <div class="me-2">
                        <div class="d-flex align-items-center">
                            <a href="{{ url('packages') }}"
                                class="btn btn-icon btn-sm active border rounded bg-primary text-white me-1"><i
                                    class="isax isax-menu-1"></i></a>
                            <a href="{{ url('packages-grid') }}" class="btn btn-icon border rounded btn-sm"><i
                                    ...
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                            data-bs-toggle="modal" data-bs-target="#edit_plans"><i
                                                class="isax isax-edit me-2"></i>View</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
