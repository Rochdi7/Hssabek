            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">You can use the <code>.link-*</code> classes to colorize links. Unlike the
                                <a href="{{ url('ui-utilities') }}"><code>.text-*</code> classes</a>, these classes have a
                                <code>:hover</code> and <code>:focus</code> state. Some of the link styles use a relatively
                                light foreground color, and should only be used on a dark background in order to have
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted"><a href="{{ url('ui-utilities') }}">Colored link helpers</a> have been
                                updated to pair with our link utilities. Use the new utilities to modify the link opacity,
