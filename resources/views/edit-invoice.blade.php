                                                ...
                                                <div class="row gx-3">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="1254569"
                                                                readonly="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap gap-2 mb-3">
                                                            <div class="form-check form-switch me-4">
                                                                <input class="form-check-input" type="checkbox"
                                                                    role="switch" id="require_check" checked>
                                                                <label class="form-check-label"
                                                                    for="require_check">Recurring</label>
                                                            </div>
                                                            ...
                                                            <div>
                                                                <a href="#"
                                                                    class="btn btn-icon btn-sm btn-soft-primary"><i
                                                                        class="isax isax-setting-2 text-primary fs-16"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="select">
                                                                ...
                                                                <option>Hssabek</option>
                                                            </select>
                                                        </div>
                                                        <div class="bg-light border rounded p-3 d-flex align-items-start">
                                                            <span class="avatar avatar-lg border flex-shrink-0 me-3"><img
                                                                    src="{{ URL::asset('build/img/logo-small.svg') }}"
                                                                    alt="User Img"></span>
                                                            <div>
                                                                <h6 class="fs-14 fw-semibold mb-1">Hssabek Invoice
                                                                    Management</h6>
                                                ...
                                                <div class="card shadow-none">
                                                    <div class="card-body">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div
                                                                class="bg-light border rounded p-3 d-flex align-items-start">
                                                                <span
                                                                    class="avatar avatar-lg border bg-dark flex-shrink-0 me-3"><img
                                                                        src="{{ URL::asset('build/img/icons/black-icon.png') }}"
                                                                        alt="User Img"></span>
                                                                <div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <div class="mb-3">
                                                    ...
                                                    <div>
                                                        <ul class="nav nav-tabs tab-style-1 border-0 p-0 d-flex flex-wrap row-gap-3"
                                                            role="tablist">
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link active d-inline-flex align-items-center border fs-12 fw-semibold"
                                                            ...
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link d-inline-flex align-items-center border fs-12 fw-semibold"
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane fade" id="bank" role="tabpanel">
                                                                ...
                                                                <select class="select">
                                                                    <option>Select</option>
                                                                    <option selected>Andrew - 5225655545555454 (Swiss Bank)
                                                                    </option>
