        ...
        <div class="content content-two">
            ...
            <div class="d-flex d-block align-items-center justify-content-between flex-wrap gap-3 mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap gap-2">
                    ...
                    <div>
                        <a href="{{ url('pages') }}" class="btn btn-primary d-flex align-items-center"><i
                                class="isax isax-add-circle5 me-1"></i>New Pages</a>
                    </div>
                </div>
            </div>
            <!-- End Breadcrumb -->
            ...
            <div class="mb-3">
                ...
                <div class="align-items-center gap-2 flex-wrap filter-info mt-3">
                    ...
                    <span class="tag bg-light border rounded-1 fs-12 text-dark badge"><span
                        ...
                        Selected<span class="ms-1 tag-close"><i class="fa-solid fa-x fs-10"></i></span></span>
                    <span class="tag bg-light border rounded-1 fs-12 text-dark badge"><span
                            class="num-count d-inline-flex align-items-center justify-content-center bg-success fs-10 me-1">5</span>Units
                        Selected<span class="ms-1 tag-close"><i class="fa-solid fa-x fs-10"></i></span></span>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="action-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{ url('pages') }}" class="dropdown-item d-flex align-items-center"><i
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <a href="#"
                                        class="btn btn-sm btn-danger-light d-inline-flex align-items-center me-1"
                                        data-bs-toggle="modal" data-bs-target="#view_history">
