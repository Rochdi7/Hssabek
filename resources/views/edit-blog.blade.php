                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="input-tags form-control" id="inputBox" type="text"
                                                    data-role="tagsinput" name="specialist" value="Main, Accounts">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                <label class="form-label">Content<span
                                                        class="text-danger ms-1">*</span></label>
                                                <div class="editor">Learn how automation can save time, reduce errors, and
                                                    help small businesses manage their finances efficiently.</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mb-3 pb-3 border-bottom">
                                                ...
                                                <div
                                                    ...
                                                    <p class="mb-0 text-gray-9">Drop your files here or<a href="#"
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div>
                                                                        <a href="javascript:void(0);"
                                                                            class="fs-14 fw-medium d-block">Blog1.jpg</a>
                                                                        <span class="fs-13">15.45 KB</span>
                                                                    </div>
                                                                </div>
                                                                <a href="javascript:void(0);"
                                                                    class="btn p-1 btn-light rounded-circle d-inline-flex align-items-center justify-content-center"><i
