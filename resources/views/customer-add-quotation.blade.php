                ...
                <div class="col-md-11 mx-auto">
                    <div>
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h6><a href="{{ url('customer-quotations') }}"><i
                                        class="isax isax-arrow-left me-2"></i>Quotations</a></h6>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ url('customer-quotations') }}">
                                        ...
                                        <div class="row justify-content-between">
                                            <div class="col-xl-5 col-lg-7">
                                                <div class="row gx-3">
                                                        ...
                                                        <div class="d-flex align-items-center mb-3">
                                                            <div class="form-check me-3">
                                                                <input class="form-check-input" type="radio"
                                                                    name="Radio-2" id="Radio-sm-1" checked="">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
                                                            <label class="form-label">Create Quotation with/without
                                                                GST</label>
                                                            <select class="select">
                                    ...
                                    <div class="border-bottom mb-4 pb-3">
                                        ...
                                        <div>
                                            <a href="javascript:void(0);"
                                                class="d-inline-flex align-items-center add-invoice-data"><i
