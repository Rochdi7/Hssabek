...
return [
    ...
    /*
     * The prefix that will be prepended to all media paths.
     * Used by the UuidPathGenerator to organize files as: media/{uuid}/filename
     */
     ...
     */
    'file_namer' => App\Support\MediaLibrary\RandomizedFileNamer::class,
